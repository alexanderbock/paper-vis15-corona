...
\caption{(a) The orbits and locations of SOHO, STEREO A and B in November 2009. (b) The location and orientations of the three coronagraph imagers of STEREO B with Mercury, Venus, Earth, and the Sun in the same view (not to scale).}
\end{figure}
...
\section{System}
\begin{figure}[t!]
\newcommand{\abEnsembleImageHeight}{0.7\columnwidth}
\centering
